...
class UpdateRoleUseCase {
  ...
  async execute(input: RoleProps): AsyncResult<boolean> {
    ...
    return await this.repo.update(role);
  }
}

const singletonUpdateRoleUseCase = new UpdateRoleUseCase(
  singletonRoleRepository,
);

export { UpdateRoleUseCase, singletonUpdateRoleUseCase };
